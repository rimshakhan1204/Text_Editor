...
public class Texteditorp extends JFrame implements ActionListener
{
            MenuBar mbar;
...
{
dispose();
Texteditorp note1 = new Texteditorp("Untitled-Notepad");
...
{
Texteditorp note = new Texteditorp("Untitled-Notepad");
